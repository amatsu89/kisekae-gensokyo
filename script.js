...
const parts = {
  ...
  hair: ['霊夢の髪.png','魔理沙の髪.png','パチュリーの髪.png','レミリアの髪.png','妹紅の髪.png','雛の髪.png','早苗の髪.png','早苗の髪（短）.png','さとりの髪.png','こいしの髪.png','こいしの髪（智）.png','ナズーリンの髪.png','小傘の髪.png','白蓮の髪.png','神子の髪.png','董子の髪.png','隠岐奈の髪.png','ちやりの髪.png','ユイマンの髪.png','魅魔の髪.png'],
  face: ['霊夢の顔.png','魔理沙の顔.png','パチュリーの顔.png','レミリアの顔.png','妹紅の顔.png','雛の顔.png','早苗の顔.png','さとりの顔.png','こいしの顔.png','ナズーリンの顔.png','小傘の顔.png','白蓮の顔.png','神子の顔.png','董子の顔.png','隠岐奈の顔.png','ちやりの顔.png','ユイマンの顔.png','魅魔の顔.png'],
  ...
  dress: ['七曜魔女のネグリジェ.png','僧侶のドレス.png','聖徳王のワンピース.png','王女のワンピース.png','ドット柄水着.png','シンプルな水着.png','ベルト付水着.png'],
  socks: ['リボン付きくつした（水）.png','令嬢のくつした.png','折り曲げくつした（白）.png','フリルくつした（白）.png','長くつした（白）.png'],
  shoes: ['靴（茶）.png','靴（青）.png','靴（黒）.png','ブーツ（黒）.png','スリッパ（ピンク）.png','下駄.png','不老不死のブーツ.png','厄神様のブーツ.png','無意識のブーツ（黒）.png','無意識のブーツ（茶）.png','僧侶のブーツ.png','聖徳王の靴.png'],
  outer: ['魔法使いのポンチョ.png','七曜魔女のアウター.png','ダウザーのポンチョ.png','オカルトチックなマント（前）.png','秘神の上衣.png','悪霊さんのコート.png'],
  accessories: ['メガネ（赤）.png','七曜魔女のイヤリング.png','マフラー（ピンク）.png','マフラー（赤）.png','ペンデュラム.png','首掛け数珠.png','博麗の袖.png','風祝の袖.png','厄神様のリボン（腕）.png','聖徳王のブレスレット.png','冬用手袋（ピンク）.png','腰付き七星剣.png'],
  sidehair: ['霊夢の髪（前）.png','魔理沙の三つ編み.png','パチュリーの髪（前）.png','早苗の髪（前）.png','早苗の髪（短、前）.png','雛の髪（前）.png','こいしの髪（前）.png','董子のおさげ.png'],
  headwear: ['魔法使いの帽子（黒）.png','魔法使いの帽子（紫）.png','魔法使いの帽子（茶）.png','魔法使いの帽子（青）.png','七曜魔女の帽子.png','令嬢の帽子.png','不老不死のリボン.png','厄神様のリボン（小）.png','蛙の髪飾り.png','覚妖怪のカチューシャ.png','無意識の帽子（黒）.png','無意識の帽子（茶）.png','聖徳王の耳当て.png','オカルトチックな帽子.png','秘神の帽子.png','悪霊さんの帽子.png','水泳ゴーグル.png','笠.png'],
  item: ['博麗のお祓い棒.png','風祝のお祓い棒.png','箒.png','ダウジングロッド.png','笏.png','悪霊さんのステッキ.png'],
  others: ['第三の目.png','閉じた第三の目.png','唐傘お化け.png','パイソン.png']
 };

parts.dress = [
  '七曜魔女のネグリジェ.png','僧侶のドレス.png','聖徳王のワンピース.png','王女のワンピース.png','ドット柄水着.png','シンプルな水着.png','ベルト付水着.png'
];
